...
<head>
  ...
  <title>Loonatic Ordering System : Order Details</title>
  <!-- Bootstrap -->
  ...
  <?php include_once 'nav_bar.php'; ?>
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a181676, tbl_staffs_a181676_pt2,
          tbl_customers_a181676_pt2 WHERE
          tbl_orders_a181676.fld_staff_num = tbl_staffs_a181676_pt2.fld_staff_num AND
          tbl_orders_a181676.fld_customer_num = tbl_customers_a181676_pt2.fld_customer_num AND
          fld_order_num = :oid");
